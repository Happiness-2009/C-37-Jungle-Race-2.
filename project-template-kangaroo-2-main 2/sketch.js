...
function draw() {
  ...
  //set velocity of each game odject to 0
  jungle.velocityX=0;
  kangaroo.velocityY=0;
  obstaclesGroup.setVelocityX.each(0);
  shrubeGroup.setVelocityX.each(0);

  //change the kangaroo animation
  kangaroo.changeAnimation("collided",kangaroo_collided);

  //set lifetime of the game objects sothat they are never distroyed
  obstaclesGroup.setLifetimeEach(-1);
  shrubsGroup.setLifetimeEach(-1);
